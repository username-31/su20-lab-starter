...
mapLoop:
    ...
    # Mistake 5B: Wrong instruction
    # Prev: lw a1, 0(s1)
    mv a1, s1        # put the address of the function back into a1 to prepare for the recursion
    
    # Mistake 4: Didn't save registers to the stack before calling subroutine.
    addi sp, sp, -4
    sw ra, 0(sp)
